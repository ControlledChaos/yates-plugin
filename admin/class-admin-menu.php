...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $options = get_field( 'yates_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            $links = get_field( 'yates_links_manager', 'option' );
        } else {
            $links = get_option( 'yates_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            // Get options.
            $appearance = get_option( 'yates_hide_appearance' );
            $plugins    = get_option( 'yates_hide_plugins' );
            $users      = get_option( 'yates_hide_users' );
            $tools      = get_option( 'yates_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $menus_link   = get_field( 'yates_menus_position', 'option' );
            $widgets_link = get_field( 'yates_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'yates_menus_position' );
            $widgets_link = get_option( 'yates_widgets_position' );
