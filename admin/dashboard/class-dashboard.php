...
class Dashboard {
	...
	private function dependencies() {
        ...
        // require YATES_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require YATES_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $hide = get_field( 'yates_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'yates_hide_welcome' );
            $gutenberg  = get_option( 'yates_hide_try_gutenberg' );
            $wp_news    = get_option( 'yates_hide_wp_news' );
            $quickpress = get_option( 'yates_hide_quickpress' );
            $at_glance  = get_option( 'yates_hide_at_glance' );
            $activity   = get_option( 'yates_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'yates' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once YATES_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once YATES_PATH . 'partials/help/help-dashboard-widgets.php';
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( YATES_ADMIN_SLUG . '-dashboard', YATES_URL .  'admin/dashboard/assets/css/dashboard.css', [], null, 'screen' );
        }
